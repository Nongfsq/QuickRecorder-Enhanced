...
struct ScreenSelector: View {
    ...
    var body: some View {
        ZStack {
                                            ...
                                            ZStack {
                                                VStack(spacing: 4) {
                                                    ZStack{
                                                        ...
                                                        Image(nsImage: viewModel.screenThumbnails[index].image)
                                                            .resizable()
                                                            .aspectRatio(contentMode: .fit)
                                                    }.frame(width: count == 1 ? 840 : 360, height: count == 1 ? 472 : 202, alignment: .center)
                                                ...
                                                Group {
                                                    ...
                                                    Image(systemName: "checkmark.circle.fill")
                                                        ...
                                                        .opacity((selected == viewModel.screenThumbnails[index].screen) ? 1.0 : 0.0)
                                                }.offset(x: count == 1 ? 350 : 140, y: count == 1 ? 175 : 60)
                                            }
                                        }).buttonStyle(.plain)
                                    }
                                }
            ...
            .padding(.top, -5)
        }.frame(width: 1080, height: viewModel.screenThumbnails.count == 1 ? 700 : 620)
    }
