...
struct OptionsView: View {
    ...
    private let middleLabelColumnWidth: CGFloat = 86
    private let middleControlColumnWidth: CGFloat = 136
    private let audioColumnWidth: CGFloat = 230
    ...
    var body: some View {
        VStack(spacing: 6) {
            HStack(alignment: .top, spacing: 14) {
                ...
                .frame(width: middleLabelColumnWidth, alignment: .leading)
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    .buttonStyle(.borderless)
                    .frame(width: middleControlColumnWidth, alignment: .leading)
                    ...
                    .buttonStyle(.borderless)
                    .disabled(ud.bool(forKey: "withAlpha"))
                    .frame(width: middleControlColumnWidth, alignment: .leading)
                    Toggle("", isOn: $adaptiveVFR)
                        .labelsHidden()
                        .disabled(ud.bool(forKey: "withAlpha") || recordHDR)
                        .frame(width: middleControlColumnWidth, alignment: .leading)
                ...
                .frame(width: audioColumnWidth, alignment: .leading)
            }
            .frame(
                width: labelColumnWidth + controlColumnWidth + middleLabelColumnWidth + middleControlColumnWidth + audioColumnWidth + 84,
                height: 108,
                alignment: .leading
            )
